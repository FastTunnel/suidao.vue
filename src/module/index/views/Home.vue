...
<template>
  <div>
    <div class="container-xl">
      <div class="welcome">基于开源<el-link
          :underline="false"
          href="https://github.com/SpringHgui/FastTunnel"
          target="_blank"
        >FastTunnel</el-link>实现的内网穿透服务</div>
    </div>
    <div class="container-xl">
      <div class="download">
        <el-link
        ...
        >
          <el-card class="box-card">
            <div class="notice-box">
              ...
              <p class="notice-box-body">我是站长，无需公网IP，不用机房托管，虚拟主机的价格，独立服务器的配置，建网站，私有云。</p>
            </div>
          </el-card>
        </el-col>
        <el-col
        ...
        >
          <el-card class="box-card">
            ...
            <div class="notice-box">
              ...
              <p class="notice-box-body">我常出差：链接系统远程桌面，在外模拟家中电脑，手机也能远程桌面，提取资料简单快捷。</p>
            </div>
          </el-card>
        </el-col>
        <el-col
        ...
        >
          <el-card class="box-card">
            <div class="notice-box">
              ...
              <p class="notice-box-body">我是账务，支持OA办公/财务软件/连锁店管理，把分支办公室连起来，还支持远程操作打印机。</p>
            </div>
          </el-card>
        </el-col>
        <el-col
        ...
        >
          <el-card class="box-card">
            ...
            <div class="notice-box">
              ...
              <p class="notice-box-body">我是程序员，抱上笔记本，来一场说走就走的旅行，知你如知己，正如写到这，想到了你此刻的目光。</p>
            </div>
          </el-card>
        </el-col>
      </el-row>
        ...
        >
          <el-card class="box-card">
            ...
            <div class="notice-box">
              ...
              <p class="notice-box-body">支持多个平台的客户端, window, linux, mac等.</p>
            </div>
          </el-card>
        </el-col>
        <el-col
        ...
        >
          <el-card class="box-card">
            ...
            <div class="notice-box">
              ...
              <p class="notice-box-body">可以根据需要设置通过域名白名单，账号验证访问，数据加密等。</p>
            </div>
          </el-card>
        </el-col>
        <el-col
        ...
        >
          <el-card class="box-card">
            ...
            <div class="notice-box">
              ...
              <p class="notice-box-body">第三代内网穿透工具，无需设置路由端口映射，无需公网IP，很多用户都是动态IP，没有关系一样可以实现内网穿透。</p>
            </div>
          </el-card>
        </el-col>
        <el-col
